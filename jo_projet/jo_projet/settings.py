"""
Django settings for jo_projet project.
...
SECRET_KEY = 'django-insecure-j1ssy5dai0z9mza7=r4r9#ij2$@&)5s@)a0b_sxx0dhde0)#s+'
...
DATE_INPUT_FORMATS = ['%Y-%m-%d']  # Format français pour les dates
